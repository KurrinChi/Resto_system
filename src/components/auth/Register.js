...
import { User as UserIcon, Mail, Lock, ArrowRight, Phone } from 'lucide-react';
export const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!validatePhone(phone))
            return setError('Please enter a valid Philippine phone number (09XXXXXXXXX)');
        setLoading(true);
        try {
    ...
    return (_jsx("div", { style: { position: 'fixed', inset: 0, overflow: 'auto' }, children: _jsxs("div", { className: "min-h-screen flex", children: [_jsxs("div", { className: "hidden lg:flex w-1/2 relative", style: {
                        ...
                        backgroundPosition: 'center',
                                ...
                                background: `linear-gradient(135deg, ${THEME.colors.primary.DEFAULT}dd, ${THEME.colors.primary.dark}dd)`
                                                            ...
                                                            color: THEME.colors.text.primary,
                                                            '--tw-ring-color': THEME.colors.primary.DEFAULT
                                                        }, required: true })] })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium mb-2", style: { color: THEME.colors.text.secondary }, children: "Password" }), _jsxs("div", { className: "relative", children: [_jsx(Lock, { className: "absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5", style: { color: THEME.colors.text.tertiary } }), _jsx("input", { type: "password", value: password, onChange: (e) => setPassword(e.target.value), placeholder: "Create a password (min 6 characters)", className: "w-full pl-11 pr-4 py-3 rounded-lg border outline-none focus:ring-2 transition-all", style: {
                                                            backgroundColor: THEME.colors.background.secondary,
                                                            borderColor: THEME.colors.border.DEFAULT,
                                                            color: THEME.colors.text.primary,
                                                            '--tw-ring-color': THEME.colors.primary.DEFAULT
                                                        }, required: true, minLength: 6 })] })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium mb-2", style: { color: THEME.colors.text.secondary }, children: "Phone Number" }), _jsxs("div", { className: "relative", children: [_jsx(Phone, { className: "absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5", style: { color: THEME.colors.text.tertiary } }), _jsx("input", { type: "tel", value: phone, onChange: (e) => setPhone(e.target.value), placeholder: "09XX-XXX-XXXX", className: "w-full pl-11 pr-4 py-3 rounded-lg border outline-none focus:ring-2 transition-all", style: {
                                                            backgroundColor: THEME.colors.background.secondary,
                                                            borderColor: THEME.colors.border.DEFAULT,
                                                            color: THEME.colors.text.primary,
                                                            '--tw-ring-color': THEME.colors.primary.DEFAULT
