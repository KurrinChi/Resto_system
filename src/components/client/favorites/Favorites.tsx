    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm mt-1" style={{ color: THEME.colors.text.tertiary }}>
          {favoriteItems.length} item{favoriteItems.length !== 1 ? 's' : ''} in your favorites
        </p>
      </div>
      ...
      {favoriteItems.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-16">
          <div className="rounded-full p-6 mb-4" style={{ backgroundColor: THEME.colors.background.tertiary }}>
            <Heart className="w-16 h-16" style={{ color: THEME.colors.text.tertiary }} />
          </div>
          ...
          <p className="text-sm text-center max-w-md" style={{ color: THEME.colors.text.tertiary }}>
            Click the heart icon on items you love to add them to your favorites
          </p>
        </div>
      ) : (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {favoriteItems.map((item, index) => (
            <Card 
              key={item.id} 
              className="relative overflow-hidden favorites-card-hover-zoom" 
              padding="none"
              style={{ 
            ...
            >
              ...
              <div className="p-4">
                <h3 className="text-base font-semibold mb-1" style={{ color: THEME.colors.text.primary }}>
                  {item.name}
                </h3>
                ...
                <div className="flex items-center justify-between mb-3">
                  <span className="text-lg font-bold" style={{ color: THEME.colors.primary.DEFAULT }}>
