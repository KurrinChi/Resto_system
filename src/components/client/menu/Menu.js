...
export const Menu = () => {
    ...
    return (_jsxs("div", { className: "flex flex-col lg:flex-row gap-4 lg:gap-6 h-auto lg:h-[calc(100vh-8rem)]", children: [_jsx("div", { className: "w-full lg:w-64 flex-shrink-0 flex flex-col overflow-hidden", children: _jsxs("div", { className: "flex flex-col h-auto lg:h-full overflow-y-auto rounded-2xl p-4", style: { backgroundColor: THEME.colors.background.secondary, border: `1px solid ${THEME.colors.border.DEFAULT}` }, children: [_jsx("h3", { className: "text-lg font-semibold mb-4 flex-shrink-0", style: { color: THEME.colors.text.primary }, children: "Filters" }), _jsxs("div", { className: "mb-6", children: [_jsx("label", { className: "block text-sm font-medium mb-2", style: { color: THEME.colors.text.primary }, children: "Price Range" }), _jsxs("div", { className: "space-y-2", children: [_jsx("input", { type: "range", min: "0", max: "1000", step: "0.5", value: priceRange[1], onChange: (e) => setPriceRange([0, parseFloat(e.target.value)]), className: "w-full" }), _jsxs("div", { className: "flex justify-between text-xs", style: { color: THEME.colors.text.tertiary }, children: [_jsxs("span", { children: ["\u20B1", priceRange[0]] }), _jsxs("span", { children: ["\u20B1", priceRange[1]] })] })] })] }), _jsx("div", { className: "mb-4", children: _jsxs("label", { className: "flex items-center gap-2 cursor-pointer", children: [_jsx("input", { type: "checkbox", checked: showDiscounts, onChange: (e) => setShowDiscounts(e.target.checked), className: "w-4 h-4" }), _jsx("span", { className: "text-sm", style: { color: THEME.colors.text.primary }, children: "Discounts" })] }) }), _jsx("div", { className: "mb-4", children: _jsxs("label", { className: "flex items-center gap-2 cursor-pointer", children: [_jsx("input", { type: "checkbox", checked: showBestSellers, onChange: (e) => setShowBestSellers(e.target.checked), className: "w-4 h-4" }), _jsx("span", { className: "text-sm", style: { color: THEME.colors.text.primary }, children: "Best Sellers" })] }) }), _jsx("div", { className: "mb-4", children: _jsxs("label", { className: "flex items-center gap-2 cursor-pointer", children: [_jsx("input", { type: "checkbox", checked: showNewOffers, onChange: (e) => setShowNewOffers(e.target.checked), className: "w-4 h-4" }), _jsx("span", { className: "text-sm", style: { color: THEME.colors.text.primary }, children: "New Offers" })] }) })] }) }), _jsxs("div", { className: "flex-1 flex flex-col overflow-hidden min-h-[400px] lg:min-h-0", children: [_jsxs("div", { className: "flex-shrink-0 rounded-2xl p-4", style: { backgroundColor: THEME.colors.background.secondary, border: `1px solid ${THEME.colors.border.DEFAULT}` }, children: [_jsx("h2", { className: "text-xl font-semibold", style: { color: THEME.colors.text.primary }, children: "Menu" }), _jsx("div", { className: "mt-3 flex gap-2 flex-wrap", children: categories.map((c) => (_jsxs("button", { onClick: () => setFilter(c), className: `px-3 py-1 rounded-full text-sm ${filter === c ? 'font-semibold' : ''}`, style: {
