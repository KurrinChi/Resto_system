...
export const Dashboard = () => {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "rounded-3xl p-8 backdrop-blur-md border relative overflow-hidden", style: {
                    ...
                    borderColor: THEME.colors.border.DEFAULT,
                }, children: [_jsxs("div", { className: "flex items-center gap-4 mb-6", children: [_jsx("div", { className: "w-12 h-12 rounded-2xl flex items-center justify-center", style: { backgroundColor: THEME.colors.background.tertiary }, children: _jsx(DollarSign, { className: "w-6 h-6", style: { color: THEME.colors.text.primary } }) }), _jsxs("div", { children: [_jsx("p", { className: "text-xs", style: { color: THEME.colors.text.tertiary }, children: "Total Revenue (This Month)" }), _jsxs("h1", { className: "text-5xl font-bold", style: { color: THEME.colors.text.primary }, children: ["$", stats?.total_revenue?.toLocaleString() || '0', _jsx("span", { className: "text-2xl", children: ".00" })] })] })] }), _jsxs("div", { className: "flex flex-wrap gap-3 mb-6", children: [_jsxs("div", { className: "flex items-center gap-2 px-4 py-2 rounded-full", style: { backgroundColor: "rgba(16, 185, 129, 0.2)" }, children: [_jsx(CheckCircle, { className: "w-4 h-4", style: { color: "#10b981" } }), _jsx("span", { className: "text-sm font-medium", style: { color: THEME.colors.text.primary }, children: "$25,000" }), _jsx("span", { className: "text-xs", style: { color: THEME.colors.text.tertiary }, children: "Paid" })] }), _jsxs("div", { className: "flex items-center gap-2 px-4 py-2 rounded-full", style: { backgroundColor: "rgba(245, 158, 11, 0.2)" }, children: [_jsx(DollarSign, { className: "w-4 h-4", style: { color: "#f59e0b" } }), _jsx("span", { className: "text-sm font-medium", style: { color: THEME.colors.text.primary }, children: "$10,000" }), _jsx("span", { className: "text-xs", style: { color: THEME.colors.text.tertiary }, children: "Pending" })] }), _jsxs("div", { className: "flex items-center gap-2 px-4 py-2 rounded-full border-2 border-dashed", style: {
                                    backgroundColor: "rgba(156, 163, 175, 0.1)",
                                    borderColor: THEME.colors.border.light,
                                }, children: [_jsx("span", { className: "text-sm font-medium", style: { color: THEME.colors.text.primary }, children: "$38,575" }), _jsx("span", { className: "text-xs", style: { color: THEME.colors.text.tertiary }, children: "Processing" })] })] }), _jsxs("div", { className: "flex flex-wrap gap-6 text-sm", children: [_jsxs("div", { children: [_jsxs("span", { style: { color: THEME.colors.text.tertiary }, children: ["Restaurant:", " "] }), _jsx("span", { style: { color: THEME.colors.text.primary }, className: "font-medium", children: "Restaurant Hub" })] }), _jsxs("div", { children: [_jsx("span", { style: { color: THEME.colors.text.tertiary }, children: "Period: " }), _jsx("span", { style: { color: THEME.colors.text.primary }, className: "font-medium", children: "October 2025" })] }), _jsxs("div", { children: [_jsxs("span", { style: { color: THEME.colors.text.tertiary }, children: ["Growth Rate:", " "] }), _jsx("span", { style: { color: "#10b981" }, className: "font-medium", children: "+18.5%" })] }), _jsxs("div", { children: [_jsxs("span", { style: { color: THEME.colors.text.tertiary }, children: ["Days Active:", " "] }), _jsx("span", { style: { color: THEME.colors.text.primary }, className: "font-medium", children: "22 Days" })] })] })] }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4", children: [_jsxs("div", { className: "p-6 rounded-2xl backdrop-blur-sm border", style: {
                            ...
                            backgroundColor: THEME.colors.background.secondary,
                            borderColor: THEME.colors.border.DEFAULT,
                        }, children: [_jsx("h3", { className: "text-lg font-semibold mb-6", style: { color: THEME.colors.text.primary }, children: "Recent Activity" }), _jsx("div", { className: "space-y-4", children: [
                                    {
                                        time: "2 min ago",
                                ...
                                ].map((activity, index) => (_jsxs("div", { className: "flex items-center gap-4", children: [_jsx("div", { className: "w-2 h-2 rounded-full flex-shrink-0", style: { backgroundColor: activity.color } }), _jsxs("div", { className: "flex-1", children: [_jsx("p", { className: "text-sm", style: { color: THEME.colors.text.primary }, children: activity.action }), _jsx("p", { className: "text-xs", style: { color: THEME.colors.text.tertiary }, children: activity.time })] })] }, index))) })] }), _jsxs("div", { className: "p-6 rounded-2xl backdrop-blur-sm border", style: {
                            backgroundColor: THEME.colors.background.secondary,
                            borderColor: THEME.colors.border.DEFAULT,
                        }, children: [_jsx("h3", { className: "text-lg font-semibold mb-6", style: { color: THEME.colors.text.primary }, children: "Top Selling Items" }), _jsx("div", { className: "space-y-4", children: [
                                ...
                                ].map((item, index) => (_jsxs("div", { className: "flex items-center justify-between p-3 rounded-xl", style: { backgroundColor: THEME.colors.background.tertiary }, children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "w-8 h-8 rounded-lg flex items-center justify-center", style: {
                                                        backgroundColor: `rgba(${index === 0
                                                            ...
                                                            color: index === 0
                                                                ...
                                                                : index === 1
                                                                    ? "#3b82f6"
                                                                    : "#f59e0b",
                                                        } }) }), _jsxs("div", { children: [_jsx("p", { className: "text-sm font-medium", style: { color: THEME.colors.text.primary }, children: item.name }), _jsxs("p", { className: "text-xs", style: { color: THEME.colors.text.tertiary }, children: [item.orders, " orders"] })] })] }), _jsx("p", { className: "text-sm font-bold", style: { color: THEME.colors.text.primary }, children: item.revenue })] }, index))) })] })] }), _jsxs("div", { className: "p-6 rounded-2xl backdrop-blur-sm border", style: {
                    backgroundColor: THEME.colors.background.secondary,
                    borderColor: THEME.colors.border.DEFAULT,
